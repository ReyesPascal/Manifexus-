          ...
          <div className="flex items-center gap-3">
            ...
            {currentStep === 3 && plan && (
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-xs font-mono transition-all flex items-center gap-2 shadow-lg shadow-emerald-500/20 cursor-pointer"
              >
                <Zap className="w-4 h-4" />
