  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl max-h-[90vh] bg-[#090d16] border border-slate-700/80 rounded-2xl shadow-2xl flex flex-col overflow-hidden text-slate-200 font-sans">
        ...
        {/* Console Header Bar */}
        <div className="px-6 py-4 border-b border-slate-800 bg-[#07090e] flex items-center justify-between flex-shrink-0">
          ...
          <div className="flex items-center gap-2">
            {!isCompleted && !isFailed && (
              <span className="px-2.5 py-1 rounded-full text-xs font-mono bg-cyan-950/80 border border-cyan-500/40 text-cyan-300 flex items-center gap-1.5 animate-pulse">
                <span className="w-2 h-2 rounded-full bg-cyan-400"></span>
                RUNNING
              </span>
            )}
            {isCompleted && (
              <span className="px-2.5 py-1 rounded-full text-xs font-mono bg-emerald-950/80 border border-emerald-500/40 text-emerald-300 flex items-center gap-1.5">
